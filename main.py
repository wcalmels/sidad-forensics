"""
ForensicsAgent-01 — phi47 SIDAD Agent
...
AGENT_ID       = os.environ.get("AGENT_ID",   "forensics_001")
AGENT_NAME     = os.environ.get("AGENT_NAME", "ForensicsAgent-01")
...
os.environ.setdefault("NEMOSINE_DB", f"/tmp/forensics_001.db")
...
# ── Import agent ──────────────────────────────────
from specialized_agents import ForensicsAgent
from federated_phi import FederatedHub

hub   = FederatedHub(db_path=f"/tmp/forensics_001_hub.db", remote_url=HUB_URL)
